...
Thank you!
        ...
        print(f"✅ Reminder SMS sent to {patient_phone}")
...
Thank you for your patience!
        ...
        print(f"✅ Queue update SMS sent to {patient_phone}")
        ...
        print(f"❌ Failed to send queue update SMS: {e}")
        return {
            'success': False,
            'error': str(e)
        }
...
Medical staff will attend to you shortly.
        ...
        print(f"✅ Emergency alert SMS sent to {patient_phone}")
